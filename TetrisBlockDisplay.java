...
public class TetrisBlockDisplay extends JComponent implements KeyListener
{
    ...
    public TetrisBlockDisplay(MyBoundedGrid<Block> board)
    {
        this.board = board;
